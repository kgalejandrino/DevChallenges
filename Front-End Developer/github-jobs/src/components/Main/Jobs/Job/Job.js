        ...
        <div className="Job">
            ...
            <div className="job-right--box">
                <div className="city_container">
                    <span class="material-icons city-icon">public</span>
                    <span>New York</span>
                </div>
